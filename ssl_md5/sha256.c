...
/*   Updated: 2019/08/25 20:16:23 by hypark           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void				fill_sha256(t_sha256 *sha256, uint16_t block_n)
{
	...
	i = 15;
	while (++i < 64)
		sha256->w[i] = W_I(sha256->w[i - 2], sha256->w[i - 7],
...
static void				process_sha256(t_sha256 *sha256)
{
	...
	while (++i < 64)
	{
		temp_1 = T1(sha256->words[4], sha256->words[5],
				sha256->words[6], sha256->words[7],
				g_k[i], sha256->w[i]);
		temp_2 = T2(sha256->words[0], sha256->words[1],
				sha256->words[2]);
